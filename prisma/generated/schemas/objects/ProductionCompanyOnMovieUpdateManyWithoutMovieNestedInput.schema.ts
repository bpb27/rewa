...
const Schema: z.ZodType<Prisma.ProductionCompanyOnMovieUpdateManyWithoutMovieNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductionCompanyOnMovieUpdateManyWithoutMovieNestedInputObjectSchema =
  Schema;
