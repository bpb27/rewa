...
const Schema: z.ZodType<Prisma.ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutMovieInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutMovieInputObjectSchema =
  Schema;
