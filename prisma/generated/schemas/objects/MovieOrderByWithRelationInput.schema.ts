...
import { CastOrderByRelationAggregateInputObjectSchema } from './CastOrderByRelationAggregateInput.schema';
import { CrewOrderByRelationAggregateInputObjectSchema } from './CrewOrderByRelationAggregateInput.schema';
...
const Schema: z.ZodType<Prisma.MovieOrderByWithRelationInput> = z
  .object({
    ...
    cast: z
      .lazy(() => CastOrderByRelationAggregateInputObjectSchema)
      .optional(),
    crew: z
      .lazy(() => CrewOrderByRelationAggregateInputObjectSchema)
      .optional(),
    genres: z
