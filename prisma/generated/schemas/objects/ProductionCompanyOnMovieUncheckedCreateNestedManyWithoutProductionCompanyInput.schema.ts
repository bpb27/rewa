...
const Schema: z.ZodType<Prisma.ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutProductionCompanyInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutProductionCompanyInputObjectSchema =
  Schema;
