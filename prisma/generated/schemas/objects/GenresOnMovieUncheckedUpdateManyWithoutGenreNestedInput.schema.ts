...
const Schema: z.ZodType<Prisma.GenresOnMovieUncheckedUpdateManyWithoutGenreNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const GenresOnMovieUncheckedUpdateManyWithoutGenreNestedInputObjectSchema =
  Schema;
