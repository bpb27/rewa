...
import { GenresOnMovieUpdateManyWithoutMovieNestedInputObjectSchema } from './GenresOnMovieUpdateManyWithoutMovieNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.MovieUpdateWithoutProduction_companiesInput> = z
  .object({
    id: z
      .union([
        z.number(),
    ...
    crew: z
      ...
      .optional(),
    genres: z
      .lazy(() => GenresOnMovieUpdateManyWithoutMovieNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const MovieUpdateWithoutProduction_companiesInputObjectSchema = Schema;
