import { z } from 'zod';
import { CastCreateNestedManyWithoutMovieInputObjectSchema } from './CastCreateNestedManyWithoutMovieInput.schema';
...
const Schema: z.ZodType<Prisma.MovieCreateWithoutProduction_companiesInput> = z
  .object({
    id: z.number(),
    adult: z.boolean(),
    ...
    vote_count: z.number(),
    cast: z
      .lazy(() => CastCreateNestedManyWithoutMovieInputObjectSchema)
      .optional(),
    crew: z
...
export const MovieCreateWithoutProduction_companiesInputObjectSchema = Schema;
