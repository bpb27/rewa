...
const Schema: z.ZodType<Prisma.ProductionCompanyOnMovieUpdateManyWithoutProductionCompanyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductionCompanyOnMovieUpdateManyWithoutProductionCompanyNestedInputObjectSchema =
  Schema;
