...
import { ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutMovieInputObjectSchema } from './ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutMovieInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.MovieUncheckedCreateWithoutGenresInput> = z
  .object({
    id: z.number(),
    adult: z.boolean(),
    ...
    production_companies: z
      .lazy(
        () =>
          ProductionCompanyOnMovieUncheckedCreateNestedManyWithoutMovieInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const MovieUncheckedCreateWithoutGenresInputObjectSchema = Schema;
